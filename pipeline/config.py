...
# Hugging Face id of the Qwen weights ("Qwen/Qwen2.5-VL-7B-Instruct" is the
# documented heavier fallback if 3B quality falls short).
QWEN_MODEL_ID: str = os.environ.get("QWEN_MODEL_ID", "Qwen/Qwen2.5-VL-3B-Instruct")
